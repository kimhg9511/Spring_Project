...
<div id="registerOK" class="alert alert-info hidden" role="alert">새
	글이 등록되었습니다.</div>
<div id="removeOK" class="alert alert-danger hidden" role="alert">글이
	삭제되었습니다.</div>
...
<a href="/board/dummy"><button class="btn btn-primary">dummy
		생성</button></a>
<script>
	var result = '${result}';
	$(function() {
